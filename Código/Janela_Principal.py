...
class JanelaPrincipal():
    def __init__(self) -> None:
        ...
        self._configuraJanela()
        self.janelaPrincipal.mainloop()

    def _configuraJanela(self):
        ...
        self.janelaPrincipal.iconphoto(True, self.__PegaImagemJpg("X.jpg", 15))
    ...
    def cria_botao_iniciar(self):
        self.iniciarJogo = Button(
            self.janelaPrincipal, text="Iniciar o Jogo", font=("Times", 15), command=self.clique_botao).grid(row=2, column=0, columnspan=2,pady=10)
    ...
    def clique_botao(self):
        nomeJogador1 = self.jogador1Entry.get()
        nomeJogador2 = self.jogador2Entry.get()
        # Pega os valores digitados nas caixas de texto
        if nomeJogador1=="" or nomeJogador2=="":
            Label(self.janelaPrincipal, text="Digite o jogador 1 e o jogador 2 para continuar.",font=("Times", 15)).grid(row=4,column=0,columnspan=2)
            return
        ...
        JanelaJogo(nomeJogador1,nomeJogador2)
        # Cria outra nova
